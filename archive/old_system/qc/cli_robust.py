...
from .core.graceful_degradation import fail_fast_manager, ensure_essential_functionality
from .core.robust_cli_operations import RobustCLIOperations
from .monitoring.system_monitor import system_monitor, start_monitoring, stop_monitoring
...
class RobustCLI:
    ...
    async def initialize(self):
        ...
        try:
            await start_monitoring(interval=300)  # Check every 5 minutes
            print("[HEALTH] System monitoring started")
    ...
    async def system_health_check(self) -> bool:
        ...
        try:
            ...
            health_report = await system_monitor.get_system_health()
    ...
    async def analyze_grounded_theory(self, input_dir: str, output_dir: str = None) -> bool:
        ...
        try:
            ...
            from .workflows.grounded_theory import GroundedTheoryWorkflow
            ...
            from .reporting.autonomous_reporter import AutonomousReporter

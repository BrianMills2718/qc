...
- Quotes must directly support or illustrate the theme
- Include exact text with accurate line numbers for research citations
- Every quote MUST be linked to a theme (100% coding rate requirement)
            ...
            for theme_data in themes_list:
                ...
                for quote_data in supporting_quotes:
                    ...
                    if isinstance(quote_data, dict):
                        ...
                        entities_list = []  # No entities extracted from string format

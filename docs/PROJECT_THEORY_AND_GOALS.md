...
3. Hardened, retrieval-first disconfirmation — **closes INV-2** (depends on INV-1). *(INV-6 — disconfirmation covers the final claim set — is already closed: negative case runs last and ingests cross-interview claims.)*

...
files, D10 timing files inside Phase 0 artifact packages, and a
...
benchmark timing evidence with environment/baseline context, full D3 Krippendorff's α/semantic agreement,

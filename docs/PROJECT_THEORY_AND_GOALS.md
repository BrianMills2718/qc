...
runners able to produce compatible input files, and one committed built-in live
canary artifact at `docs/benchmarks/inv7_live_canary_2026_06_22/`, an **externally supplied D8

...
9. **Stale-output handling** — *INV-11 hard-invalidation first slice DONE*; remaining: auto-recompute on corpus mutation and explicit active-vs-historical review-decision handling for removed claims.

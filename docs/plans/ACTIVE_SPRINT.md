...
**Current queue:**
1. Plan #63, D8 GT-fidelity bootstrap intervals: add deterministic local
   uncertainty metadata for supplied D8 rubric means without claiming
   expert-rubric acceptance or full grounded theory.

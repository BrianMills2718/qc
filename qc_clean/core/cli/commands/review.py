...
def _show_review_summary(rm: ReviewManager, state) -> int:
    ...
    print(f"  Claims to review: {summary.claims_count}")
    print(f"  Relationships to review: {summary.relationships_count}")
    print(f"  Abductive candidates to review: {summary.abductive_candidates_count}")
